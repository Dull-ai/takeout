...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    @Override
    public PageResult query(EmployeePageQueryDTO pageResult) {

        PageHelper.startPage(pageResult.getPage(),pageResult.getPageSize());

      Page<Employee> page=employeeMapper.query(pageResult);
